...
namespace Fall2024_Assignment3_tbclements.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MovieId,ReviewText,Reviewer,Publication,ReviewSentiment")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MovieId,ReviewText,Reviewer,Publication,ReviewSentiment")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
